<div id="loginModal"
    ...
    <div class="bg-white p-6 rounded-lg shadow-lg w-11/12 sm:w-3/4 md:w-1/2 lg:w-1/3 max-w-md">
        ...
        <button id="loginModalLink" class="w-full hover:bg-green-200 hover:text-green-900 text-green-700 font-semibold py-2 px-4 rounded">No account? Sign up here!</button>
    </div>
</div>